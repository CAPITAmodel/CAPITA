    ...
    SET Person&SurveyYear ;
        ...
        * Demographic variables ;
            ...
            * Hours worked per week from first and second job. (Convert categorical values into numeric values) ;
            ...
            IF HrsPerWkSp = 0 THEN HrsPerWkp = 0 ;
            ELSE IF HrsPerWkSp = 1 THEN HrsPerWkp = 2 ;
            ELSE IF HrsPerWkSp = 2 THEN HrsPerWkp = 4.5 ;
            ELSE IF HrsPerWkSp = 3 THEN HrsPerWkp = 6.5 ;
            ELSE IF HrsPerWkSp = 4 THEN HrsPerWkp = 8.5 ;
            ELSE IF HrsPerWkSp = 5 THEN HrsPerWkp = 10.5 ;
            ELSE IF HrsPerWkSp = 6 THEN HrsPerWkp = 12.5 ;
            ELSE IF HrsPerWkSp = 7 THEN HrsPerWkp = 14.5 ;
            ELSE IF HrsPerWkSp = 8 THEN HrsPerWkp = 16.5 ;
            ELSE IF HrsPerWkSp = 9 THEN HrsPerWkp = 18.5 ;
            ELSE IF HrsPerWkSp = 10 THEN HrsPerWkp = 20.5 ;
            ELSE IF HrsPerWkSp = 11 THEN HrsPerWkp = 22.5 ;
            ELSE IF HrsPerWkSp = 12 THEN HrsPerWkp = 24.5 ;
            ELSE IF HrsPerWkSp = 13 THEN HrsPerWkp = 26.5 ;
            ELSE IF HrsPerWkSp = 14 THEN HrsPerWkp = 28.5 ;
            ELSE IF HrsPerWkSp = 15 THEN HrsPerWkp = 30.5 ;
            ELSE IF HrsPerWkSp = 16 THEN HrsPerWkp = 33 ;
            ELSE IF HrsPerWkSp = 17 THEN HrsPerWkp = 35 ;
            ELSE IF HrsPerWkSp = 18 THEN HrsPerWkp = 36.5 ;
            ELSE IF HrsPerWkSp = 19 THEN HrsPerWkp = 38.5 ;
            ELSE IF HrsPerWkSp = 20 THEN HrsPerWkp = 40 ;
            ELSE IF HrsPerWkSp = 21 THEN HrsPerWkp = 41.5 ;
            ELSE IF HrsPerWkSp = 22 THEN HrsPerWkp = 43.5 ;
            ELSE IF HrsPerWkSp = 23 THEN HrsPerWkp = 45.5 ;
            ELSE IF HrsPerWkSp = 24 THEN HrsPerWkp = 48 ;
            ELSE IF HrsPerWkSp = 25 THEN HrsPerWkp = 50 ;

            * Duration of Unemployment (for use in Allowances module) ;

            IF DurUnempSp = 0 THEN DurUnempTypep = "NA" ;

            ELSE IF DurUnempSp = 1 THEN DurUnempTypep = "Lt4Wk" ;

            ELSE IF DurUnempSp = 2 THEN DurUnempTypep = "4To12Wk" ;

            ELSE IF DurUnempSp = 3 THEN DurUnempTypep = "13To25Wk" ;

            ELSE IF DurUnempSp = 4 THEN DurUnempTypep = "26To51Wk" ;
            ...
            * Type of educational institution attending ;
            ...
            ELSE IF EducInstSp = 3 THEN DO ;
                ...
                * If the person is less than 20 years old and their highest year of school
                ...
                IF AgeSp < 6 AND HighestSYearSp > 1 THEN EducInstp = "SS" ;
        ...
        * Income variables ;
            ...
            * Correction for wage and salary income including salary sacrificed amounts ;
            ...
            ELSE IncWageSWp = MAX ( 0 , IncEmpTotSWp - NonSSTotSAp ) ;
    ...
    SET Household&SurveyYear ;
		...
		* Wealth variables - aggregation at the household level ;
			...
			* Other assets (multiply by a scaling factor) ;
			...
			AssOtherHHh = &AssOtherScale * ( AssHomeContSh + AssVehicSh + AssNECSh - AssOthLoanSh - AssVehicLoanSh ) ;
