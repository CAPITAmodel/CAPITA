...
*               proportion of these dividends which are franked, based on 2012-13    *
*               TaxStats data. See the documentation on this imputation for more     *
*               information.                                                         *
**************************************************************************************;


*Proportion of dividends which are franked.  Calculated using 2012-13 Tax-stats data in separate spreadsheet*;
*************************************************************************************************************;
